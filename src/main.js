...
const insertMarkup = (element, template, where = `beforeEnd`) => {
    element.insertAdjacentHTML(where, template);
};
const multipleInsertMarkups = (quantity, element, template, where = `beforeEnd`) => {
...
topRated.classList.add('films-list--extra');
const mostCommented = document.createElement('section');
const mostCommentedHeading = document.createElement('h2');
...
mostCommented.classList.add('films-list--extra');
films.appendChild(topRated);
films.appendChild(mostCommented);